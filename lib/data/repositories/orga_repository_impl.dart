...
import '../datasources/orga_data_source.dart';
...
class OrgaRepositoryImpl implements OrgaRepository {
  ...
  @override
  Future<Either<Failure, List<OrgaUser>>> getOrgaUser(
  ...
  @override
  Future<Either<Failure, List<Orga>>> getOrgasByUser(String userId) async {
    try {
      final result = await remoteDataSource.getOrgasByUser(userId);
